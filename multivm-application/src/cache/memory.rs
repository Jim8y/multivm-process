...
mod tests {
    ...
    async fn test_memory_cache_basic_operations() {
        ...
        let value: Option<String> = cache.get("non_existent").await.unwrap();
    ...
    async fn test_memory_cache_ttl() {
        ...
        cache
            .set("test_key", &"test_value", Some(Duration::from_millis(10)))
            .await
            .unwrap();
    ...
    async fn test_memory_cache_stats() {
        ...
        // Hit
        let _: Option<String> = cache.get("test_key").await.unwrap();
        let stats = cache.get_stats().await.unwrap();

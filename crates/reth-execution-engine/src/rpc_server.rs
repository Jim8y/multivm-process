            ...
            io.add_method("eth_sendRawTransaction", |params: Params| async {
                ...
                match params.parse::<Vec<String>>() {
                    Ok(parsed) if parsed.len() >= 1 => {
                        ...
                        Ok(Value::String("0x9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8b".to_string()))
                    }
                    _ => Err(JsonRpcError::invalid_params("Expected raw transaction data"))
                }
            });

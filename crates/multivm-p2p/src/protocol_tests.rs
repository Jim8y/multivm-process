...
fn test_solana_to_evm_translation() {
    ...
    let translated = result.unwrap();
    assert_eq!(translated.metadata.get("converted_from"), Some(&"solana".to_string()));
    assert_eq!(translated.metadata.get("converted_to"), Some(&"ethereum".to_string()));
...
fn test_evm_to_solana_translation() {
    ...
    let translated = result.unwrap();
    assert_eq!(translated.metadata.get("converted_from"), Some(&"ethereum".to_string()));
    assert_eq!(translated.metadata.get("converted_to"), Some(&"solana".to_string()));
    assert!(translated.metadata.contains_key("conversion_time"));
...
fn test_solana_to_evm_converter() {
    ...
    assert_eq!(converted.metadata.get("converted_from"), Some(&"solana".to_string()));
    assert_eq!(converted.metadata.get("converted_to"), Some(&"ethereum".to_string()));
}
...
fn test_evm_to_solana_converter() {
    ...
    let converted = result.unwrap();
    assert_eq!(converted.metadata.get("converted_from"), Some(&"ethereum".to_string()));
    assert_eq!(converted.metadata.get("converted_to"), Some(&"solana".to_string()));
}
...
fn test_universal_converter() {
    ...
    let converted = result.unwrap();
    assert_eq!(converted.metadata.get("universal_conversion"), Some(&"true".to_string()));
    assert_eq!(converted.metadata.get("target_format"), Some(&"custom_format".to_string()));
}
...
fn test_protocol_error_cases() {
    ...
    assert!(capabilities.len() >= 0); // Should have some or no capabilities
